  ...
  useEffect(() => {
    ...
    class Cloud {
      ...
      draw() {
        ...
        // Sunset clouds have a pink/orange tint
        ...
        // Add subtle pink gradient to give depth
        const gradient = ctx.createLinearGradient(0, 0, 0, h)
        gradient.addColorStop(0, "rgba(255, 240, 240, 0.95)")
        gradient.addColorStop(1, "rgba(255, 210, 210, 0.95)")
    ...
    class Sun {
      ...
      draw() {
        ...
        gradient.addColorStop(0, "rgba(219, 136, 118, 0.8)")
        gradient.addColorStop(0.5, "rgba(219, 136, 118, 0.3)")
        gradient.addColorStop(1, "rgba(219, 136, 118, 0)")
    ...
    function animate() {
      ...
      gradient.addColorStop(0.0, "#db8876")
      gradient.addColorStop(0.21, "#eabc96")
      gradient.addColorStop(0.42, "#d6cbca")
      gradient.addColorStop(0.62, "#a4c8dc")
      gradient.addColorStop(1.0, "#6bafd2")
