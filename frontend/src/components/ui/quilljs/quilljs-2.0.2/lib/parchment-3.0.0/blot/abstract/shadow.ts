...
class ShadowBlot implements Blot {
  ...
  public formatAt(index: number, length: number, name: string, value: any): void {
    ...
    if (this.scroll.query(name, Scope.BLOT) != null && value) {
      ...
      const parent = this.scroll.create(this.statics.scope) as Parent & Formattable;
      blot.wrap(parent);
  ...
  public update(_mutations: MutationRecord[], _context: { [key: string]: any }): void {
    // Nothing to do by default
  }

  public wrap(name: string | Parent, value?: any): Parent {
    const wrapper = typeof name === 'string' ? (this.scroll.create(name, value) as Parent) : name;
    if (this.parent != null) {
