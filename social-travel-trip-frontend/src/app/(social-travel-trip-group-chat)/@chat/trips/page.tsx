...
/**
 * Parallel Route: @chat/trips
 * Center column - Chat area with welcome message
 */
          ...
          <div className="text-center space-y-6 max-w-md mx-auto px-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                Chọn một nhóm từ danh sách bên trái để bắt đầu trò chuyện, hoặc tạo nhóm mới để khởi đầu cuộc phiêu lưu của bạn.
              </p>
            </div>
